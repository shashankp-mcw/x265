...
@cd 12bit
cmake -G "Visual Studio 17 2022" ../../../source -DHIGH_BIT_DEPTH=ON -DEXPORT_C_API=OFF -DENABLE_SHARED=OFF -DENABLE_CLI=OFF -DMAIN12=ON %X265_CMAKE_ARGS%
if exist x265.sln (
...
@cd ..\10bit
cmake -G "Visual Studio 17 2022" ../../../source -DHIGH_BIT_DEPTH=ON -DEXPORT_C_API=OFF -DENABLE_SHARED=OFF -DENABLE_CLI=OFF %X265_CMAKE_ARGS%
if exist x265.sln (
  MSBuild /property:Configuration="Release" x265.sln
...
cmake -G "Visual Studio 17 2022" ../../../source -DEXTRA_LIB="x265-static-main10.lib;x265-static-main12.lib" -DLINKED_10BIT=ON -DLINKED_12BIT=ON %X265_CMAKE_ARGS%
if exist x265.sln (
  MSBuild /property:Configuration="Release" x265.sln
